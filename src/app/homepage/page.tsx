      ...
      <div className="bg-black p-3">
        ...
        <div className="flex flex-col gap-5 items-center px-10 sm:px-38 xl:text-left text-center">
          ...
          <div className="grid grid-cols-1 grid-rows-2 lg:grid-cols-2 xl:grid-cols-3 md:grid-cols-1 gap-5 mt-10">
            <div className=" flex flex-col items-center justify-between gap-2 border border-1 rounded-xl pt-[24px] pb-[40px] px-[24px] h-[350px] w-[250px] lg:w-[350px] sm:w-[364px] bg-[linear-gradient(to_top,_rgba(255,255,255,0)_0%,_rgba(255,255,255,0.1)_100%)]">
              <div>
            ...
            <div className="group flex flex-col items-center justify-between gap-2 border border-1 rounded-xl pt-[24px] pb-[40px] px-[24px] h-[350px] w-[250px] lg:w-[350px] sm:w-[364px] bg-[linear-gradient(to_top,_rgba(255,255,255,0)_0%,_rgba(255,255,255,0.1)_100%)]">
              <div>
        ...
        <div className="flex flex-col gap-5 items-center p-10 sm:p-38">
          ...
          <div className="mt-6 text-white">
            {loading ? (
              ...
              <div className="grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 2xl:grid-cols-6 gap-4">
                {(activeTab === "tradeable"
                  ? coins.slice(0, 12)
                  : getTopGainers()
                ).map((coin) => (
                  <div
                    key={coin.id}
                    className="flex flex-col justify-between p-[20px] w-[130px] sm:w-[176.67px] sm:h-[175px] bg-[linear-gradient(to_top,_rgba(255,255,255,0)_0%,_rgba(255,255,255,0.1)_100%)] rounded-2xl border border-amber-50/20"
                  >
                    {coin.image && (
                      <Image
                        src={coin.image}
        ...
        <div className="grid grid-cols-2 p-38">
          <div className="flex flex-col gap-5">
